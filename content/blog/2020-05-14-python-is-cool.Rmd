...
The next thing we will do is loop through the lines of text pulled from the text file. We will skip all line breaks (\n) and split the rest of the lines by spaces. Then we will remove all punctuation using regex. Using regex allows for words ending with or containing punctuation to be retained, just minus the punctuation. Any words that make it trough this process will be put into our wordList.
